	...
	$.fn[pluginName].defaults = {
		...
		translate: {
			records: {
				...
				noRecords: 'Δεν βρέθηκαν εγγραφές',
			},
			toolbar: {
				pagination: {
					items: {
						default: {
							...
							next: 'Επόμενη',
							last: 'Τελευταία',
							more: 'Και άλλα αποτελέσματα',
							input: 'Αριθμός αποτελεσμάτων',
							select: 'Επιλέξτε αριθμό αποτελεσμάτων',
							all: 'Όλα',
						},
						info: 'Αποτελέσματα {{start}} - {{end}} από {{total}}',
					},
				},
			},
		},
